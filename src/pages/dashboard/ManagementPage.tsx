    ...
    <div className="p-6 md:p-12 w-full max-w-7xl mx-auto animate-fadeIn space-y-8">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5">
        <div className="space-y-3 max-w-2xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-3 py-1 text-[10px] font-mono font-bold uppercase tracking-[0.2em] text-orange-700">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="min-w-40 rounded-3xl border-hard bg-white p-4 shadow-hard">
          ...
          <div className="min-w-40 rounded-3xl border-hard bg-zinc-950 p-4 shadow-hard text-white">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        {[
          ...
          <article key={item.label} className="rounded-[28px] border-hard bg-white p-5 shadow-hard flex items-start gap-4">
      ...
      <section className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-6">
        <article className="rounded-4xl border-hard bg-white p-6 md:p-8 shadow-hard space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {shopFacts.map(fact => (
              <div key={fact.label} className="rounded-[22px] border border-zinc-100 bg-zinc-50 p-4">
        ...
        <article className="rounded-4xl border-hard bg-zinc-950 p-6 md:p-8 shadow-hard text-white space-y-6">
          <div className="flex items-center gap-3">
          ...
          <div className="space-y-3">
            {topTables.length === 0 ? (
              ...
              topTables.map((table, index) => (
                <div key={table.tableId} className="rounded-[22px] border border-white/10 bg-white/5 p-4 flex items-center justify-between gap-4">
                  <div>
